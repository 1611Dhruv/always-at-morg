...
echo ""
echo "Binaries will be served from: https://web.always-at-morg.bid/releases/"
echo ""
echo "Next steps:"
echo "  1. Build the website: cd website && npm run build"
echo "  2. Deploy the website/build/ folder to web.always-at-morg.bid"
echo "  3. Install script will download from: https://web.always-at-morg.bid/releases/"
